...
//    public static final ModConfigSpec.BooleanValue showYawPitch;
    ...
    static {
        ...
        contextualInfoBarOffsetX = BUILDER.comment("Per-element X offset added on top of global; also applied to the contextual info bar background").defineInRange("contextualInfoBarOffsetX", 0, -100, 100);
        contextualInfoBarOffsetY = BUILDER.comment("Per-element Y offset added on top of global; also applied to the contextual info bar background").defineInRange("contextualInfoBarOffsetY", 0, -100, 100);
