...
public class AutoHideHUDConfig {
    ...
    public static final ModConfigSpec.IntValue contextualInfoBarRotation;
...
//    public static final ModConfigSpec.BooleanValue showYawPitch;
    ...
    static {
        ...
        contextualInfoBarOffsetX = BUILDER.comment("Per-element X offset added on top of global; also applied to the contextual info bar background").defineInRange("contextualInfoBarOffsetX", 0, Integer.MIN_VALUE, Integer.MAX_VALUE);
        contextualInfoBarOffsetY = BUILDER.comment("Per-element Y offset added on top of global; also applied to the contextual info bar background").defineInRange("contextualInfoBarOffsetY", 0, Integer.MIN_VALUE, Integer.MAX_VALUE);
        ...
        contextualInfoBarRotation = BUILDER.comment("Per-element rotation added on top of global; also applied to the contextual info bar background").defineInRange("contextualInfoBarRotation", 0, 0, 360);
        ...
        playerDataServerPort = BUILDER
                ...
                .defineInRange("playerDataServerPort", 25922, 1, 65535);
